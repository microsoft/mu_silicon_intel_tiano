  ...
  )
{
  ...
  AddTestCase (
    InternalTests,
    "Should fail if the header entry looks bad",
    "FitQuery.Internal.BadSig",
    ShouldFailIfFitSigIsBad,
    NULL,
    NULL,
    NULL
  ...
  AddTestCase (
    InternalTests,
    "Should fail if a type is requested that we don't know how to process",
    "FitQuery.Internal.BadType",
    ShouldFailIfTypeIsUnknown,
    NULL,
    NULL,
    NULL
  ...
  AddTestCase (
    InternalTests,
    "Should return the correct record, if found",
    "FitQuery.Internal.FoundRecord",
    ShouldReturnTheCorrectRecord,
    NULL,
    NULL,
    NULL
  ...
  AddTestCase (
    InternalTests,
    "Should pay attention to the index and return the correct record on repeats",
    "FitQuery.Internal.MultipleRecords",
    ShouldReturnTheSecondRecordForRepeats,
    NULL,
    NULL,
    NULL
