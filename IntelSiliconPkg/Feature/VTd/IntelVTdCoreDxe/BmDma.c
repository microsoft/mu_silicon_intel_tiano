  ...
  )
{
  ...
  if (!EFI_ERROR (Status)) {
    *HostAddress = (VOID *)(UINTN)PhysicalAddress;
    ...
    VTdLogAddEvent (VTDLOG_DXE_IOMMU_ALLOC_BUFFER, (UINT64)Pages, (UINT64)(UINTN)(*HostAddress));  // MU_CHANGE
  }
  ...
  )
{
  ...
  VTdLogAddEvent (VTDLOG_DXE_IOMMU_FREE_BUFFER, Pages, (UINT64)(UINTN)HostAddress);   // MU_CHANGE
