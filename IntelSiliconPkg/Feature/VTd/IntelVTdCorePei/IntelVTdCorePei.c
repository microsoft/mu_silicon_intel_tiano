  ...
  )
{
  ...
  *Mapping               = MapInfo;
  ...
  VTdLogAddEvent (VTDLOG_PEI_PPI_MAP, (UINT64)(UINTN)HostAddress, Length);    // MU_CHANGE
  return EFI_SUCCESS;
}
  ...
  )
{
  ...
  *HostAddress                        = (VOID *)(UINTN)(DmaBufferInfo->DmaBufferCurrentTop - Length);
  ...
  VTdLogAddEvent (VTDLOG_PEI_PPI_ALLOC_BUFFER, (UINT64)(UINTN)(*HostAddress), Length);    // MU_CHANGE
